...
"ERROR: The number of tokens differs from your first instruction and your first argument.",ERROR_INCORRECT_INS="ERROR: The instruction does not exist.",ERROR_INCORRECT_NUM_ARGS="ERROR: The number of arguments does not match the instruction.",ERROR_INCORRECT_ARG_TYPE="ERROR: The argument provided is incorrect.",ERROR_INSUFFICIENT_MEMORY="ERROR: Memory size is too small for the entered program.",ERROR_ADDRESS_OUT_OF_BOUNDS="ERROR: the address you are trying to input is out of bounds",ERROR_STACK_OVERFLOW=
        "ERROR: The PC is now greater than the SP. Stack overflow has occurred.", ERROR_VALUES_AFTER_LABEL = "ERROR: There are tokens following address labelling.", ERROR_LABEL_VALUE_OVERFLOW = "ERROR: The given address for the label doesn't fit within the memory constraints.", LIST_REG_NAMES = {
        R0: !0,
        R1: !0,
        R2: !0,
        R3: !0
...
MUL:{N_ARGS:2,ARG0:"R",ARG1:"R",f:do_mul,OP_CODES:[16],INS_TYPE:INS_TYPE_ARITHMETIC,ZCNO:"?-?-",INS_PC:"+3",INS_SP:"+0",INS_DESCRIPTION:"Performs "+"2's complement multiplication".link("https://en.wikipedia.org/wiki/Two's_complement#Multiplication")+" between arg0 and arg1 and places the result into arg1. The Z bit is set if the result is 0, the N bit is set if the resulting most significant bit is 1, and the C and O bit are set when the result should be greater than 0x7FFF or if the negative result should be less than 0x8000."},
        ...
        CMP: {
            ...
            ARG1: "IMR",
            f: do_cmp,
            OP_CODES: [18, 19, 20, 21, 22, 23, 24, 25, 26],
        ...
        RTN: {
            N_ARGS: 0, ARG0: "-", ARG1: "-", f: do_rtn, OP_CODES: [32], INS_TYPE: INS_TYPE_BRANCHING,
