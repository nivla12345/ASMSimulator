    ...
    var Vim = function () {
        CodeMirror.defineOption('vimMode', false, function (cm, val) {
            function lookupKey(e) {
                ...
                if (modifierCodes.indexOf(keyCode) != -1) {
                    return;
                }
        ...
        var vimApi = {
            ...
            handleKey: function (cm, key, origin) {
                ...
                if (vim.insertMode) {
                    return handleKeyInsertMode();
                }
                else {
                    return handleKeyNonInsertMode();
                }
            },
            ...
            evalInput: function (cm, vim) {
                ...
                if (operator) {
                    ...
                    if (operatorArgs.selOffset) {
                        ...
                        if (operatorArgs.selOffset.line) {
                            curEnd.ch = operatorArgs.selOffset.ch;
                        }
                        else {
                            curEnd.ch = curStart.ch + operatorArgs.selOffset.ch;
                        }
                        ...
                        if (selOffset.line) {
                            selOffset.ch = curEnd.ch;
                        }
                        else {
                            selOffset.ch = curEnd.ch - curStart.ch;
                        }
